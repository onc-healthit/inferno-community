...
class ConfidentialClientDynamicRegistrationSequenceTest < MiniTest::Unit::TestCase
  ...
  def setup
    ...
    @dynamic_registration = load_json_fixture(:confidential_client_dynamic_registration)
  end
  ...
  def test_all_pass
    ...
    # Response Must use client_secret_basic as the token_endpoint_auth_method
    stub_register = stub_request(:post, @instance.oauth_register_endpoint).
        with(body: /client_secret_basic/,
             headers: headers){|req| validate_register_payload(req)}.
