...
class ONCProgramProvenanceTest < MiniTest::Test
  def setup
    @instance = get_test_instance
    client = get_client(@instance)

    @fixture = 'provenance' # put fixture file name here
    @sequence = Inferno::Sequence::ProvenanceSequence.new(@instance, client) # put sequence here
