...
class SequenceResultTest < MiniTest::Test
  ...
  def test_update_result_counts
	...
	test_result_1 = Inferno::Models::TestResult.new
	test_result_1.required = true
	test_result_1.result = Inferno::ResultStatuses::PASS
	sequence_result.test_results << test_result_1

	test_result_2 = Inferno::Models::TestResult.new
	test_result_2.required = false
	test_result_2.result = Inferno::ResultStatuses::PASS
	sequence_result.test_results << test_result_2

	test_result_3 = Inferno::Models::TestResult.new
	test_result_3.required = true
	test_result_3.result = Inferno::ResultStatuses::OMIT
	sequence_result.test_results << test_result_3

	test_result_4 = Inferno::Models::TestResult.new
	test_result_4.required = false
	test_result_4.result = Inferno::ResultStatuses::OMIT
	sequence_result.test_results << test_result_4

	test_result_5 = Inferno::Models::TestResult.new
	test_result_5.required = true
	test_result_5.result = Inferno::ResultStatuses::TODO
	sequence_result.test_results << test_result_5

	test_result_6 = Inferno::Models::TestResult.new
	test_result_6.required = true
	test_result_6.result = Inferno::ResultStatuses::ERROR
	sequence_result.test_results << test_result_6

	test_result_7 = Inferno::Models::TestResult.new
	test_result_7.required = false
	test_result_7.result = Inferno::ResultStatuses::SKIP
	sequence_result.test_results << test_result_7

	test_result_8 = Inferno::Models::TestResult.new
	test_result_8.required = false
	test_result_8.result = Inferno::ResultStatuses::WAIT
	sequence_result.test_results << test_result_8
  ...
  def test_sequence_result_result_pass
	...
	test_result_2 = Inferno::Models::TestResult.new
	test_result_2.required = true
	test_result_2.result = Inferno::ResultStatuses::TODO
	sequence_result.test_results << test_result_2
  ...
  def test_sequence_result_result_pass_even_with_omit
	...
	test_result_2 = Inferno::Models::TestResult.new
	test_result_2.required = true
	test_result_2.result = Inferno::ResultStatuses::OMIT
	sequence_result.test_results << test_result_2
  ...
  def test_sequence_result_result_pass_when_skip_test_is_optional
	...
	test_result_2 = Inferno::Models::TestResult.new
	test_result_2.required = false
	test_result_2.result = Inferno::ResultStatuses::SKIP
	sequence_result.test_results << test_result_2
  ...
  def test_sequence_result_result_required_skip_when_no_pass_tests
	...
	test_result_1 = Inferno::Models::TestResult.new
	test_result_1.required = true
	test_result_1.result = Inferno::ResultStatuses::SKIP
	sequence_result.test_results << test_result_1
  ...
  def test_sequence_result_result_optional_skip_when_no_pass_tests
   ...
   def test_sequence_result_fail
	...
	test_result_3 = Inferno::Models::TestResult.new
	test_result_3.required = true
	test_result_3.result = Inferno::ResultStatuses::FAIL
	sequence_result.test_results << test_result_3
  ...
  def test_sequence_result_pass_when_fail_optional
	...
	test_result_2 = Inferno::Models::TestResult.new
	test_result_2.required = false
	test_result_2.result = Inferno::ResultStatuses::FAIL
	sequence_result.test_results << test_result_2
  ...
  def test_sequence_result_error
	...
	test_result_3 = Inferno::Models::TestResult.new
	test_result_3.required = true
	test_result_3.result = Inferno::ResultStatuses::ERROR
	sequence_result.test_results << test_result_3
  ...
  def test_sequence_result_pass_when_error_optional
	...
	test_result_2 = Inferno::Models::TestResult.new
	test_result_2.required = false
	test_result_2.result = Inferno::ResultStatuses::ERROR
	sequence_result.test_results << test_result_2
  ...
  def test_sequence_result_pass_fail_vs_error
	...
	test_result_1 = Inferno::Models::TestResult.new
	test_result_1.required = true
	test_result_1.result = Inferno::ResultStatuses::FAIL
	sequence_result.test_results << test_result_1
