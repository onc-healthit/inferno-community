...
module Inferno
  module Sequence
    class USCoreR4PulseOximetrySequence < SequenceBase
      group 'US Core R4 Profile Conformance'

      title 'Pulse Oximetry Tests'

      description 'Verify that Pulse Oximetry resources on the FHIR server follow the Argonaut Data Query Implementation Guide'

      test_id_prefix 'USCPO' # change me
      ...
      details %(
        ...
        returned will be checked for consistency against the [PulseOximetry Argonaut Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry)
