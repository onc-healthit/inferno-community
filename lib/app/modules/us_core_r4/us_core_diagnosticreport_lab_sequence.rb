...
module Inferno
  module Sequence
    class USCoreR4DiagnosticreportLabSequence < SequenceBase
      ...
      description 'Verify that DiagnosticReport for Laboratory Results Reporting resources on the FHIR server follow the Argonaut Data Query Implementation Guide'

      test_id_prefix 'USCDRLRR' # change me
