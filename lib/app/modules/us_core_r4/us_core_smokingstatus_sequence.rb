...
module Inferno
  module Sequence
    class USCoreR4SmokingstatusSequence < SequenceBase
      ...
      description 'Verify that Smoking Status Observation resources on the FHIR server follow the Argonaut Data Query Implementation Guide'

      test_id_prefix 'USCSSO' # change me
