...
module Inferno
  module Sequence
    class USCoreR4ImplantableDeviceSequence < SequenceBase
      group 'US Core R4 Profile Conformance'

      title 'Implantable Device Tests'

      description 'Verify that Implantable Device resources on the FHIR server follow the Argonaut Data Query Implementation Guide'

      test_id_prefix 'USCID' # change me
      ...
      details %(
        ...
        returned will be checked for consistency against the [ImplantableDevice Argonaut Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-implantable-device)
