...
module Inferno
  module Sequence
    class PediatricBmiForAgeSequence < SequenceBase
      ...
      description 'Verify that Pediatric BMI for Age Observation resources on the FHIR server follow the Argonaut Data Query Implementation Guide'

      test_id_prefix 'USCPBMIAO' # change me
