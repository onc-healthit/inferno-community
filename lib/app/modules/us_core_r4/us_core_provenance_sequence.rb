...
module Inferno
  module Sequence
    class USCoreR4ProvenanceSequence < SequenceBase
      ...
      details %(
        ...
        returned will be checked for consistency against the [Provenance Argonaut Profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-provenance)
