...
module Inferno
  module Sequence
    class USCore310BmiSequence < SequenceBase
      ...
      test :search_by_patient_code do
        ...
        code_val.each do |val|
          ...
          save_resource_ids_in_bundle(versioned_resource_class('Observation'), reply, Inferno::ValidationUtil::US_CORE_R4_URIS[:bmi])
      ...
      test 'Observation resources associated with Patient conform to US Core R4 profiles' do
        metadata do
          id '11'
          link 'http://hl7.org/fhir/StructureDefinition/bmi'
          description %(
        ...
        skip 'No resources appear to be available for this patient. Please use patients with more information.' unless @resources_found
        test_resources_against_profile('Observation', Inferno::ValidationUtil::US_CORE_R4_URIS[:bmi])
      end
