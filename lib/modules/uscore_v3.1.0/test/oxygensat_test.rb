...
describe Inferno::Sequence::USCore310OxygensatSequence do
  before do
    @sequence_class = Inferno::Sequence::USCore310OxygensatSequence
  ...
  describe 'Observation search by patient+code test' do
    before do
      ...
      @sequence = @sequence_class.new(@instance, @client)
      @observation = FHIR.from_contents(load_fixture(:oxygensat))
