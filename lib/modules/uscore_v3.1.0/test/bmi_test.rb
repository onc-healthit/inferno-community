...
describe Inferno::Sequence::USCore310BmiSequence do
  before do
    @sequence_class = Inferno::Sequence::USCore310BmiSequence
  ...
  describe 'Observation search by patient+code test' do
    before do
      ...
      @sequence = @sequence_class.new(@instance, @client)
      @observation = FHIR.from_contents(load_fixture(:bmi))
