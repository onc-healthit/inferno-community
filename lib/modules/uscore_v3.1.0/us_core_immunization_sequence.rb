  ...
  module Sequence
    class USCore310ImmunizationSequence < SequenceBase
      ...
      test :search_by_patient_date do
        ...
        search_params = {
          'patient': @instance.patient_id,
          'date': get_value_for_search_param(resolve_element_from_path(@resources_found, 'occurrence'))
        }
      ...
      test :read_interaction do
        ...
        skip 'No Immunization resources could be found for this patient. Please use patients with more information.' unless @resources_found.present?

        validate_read_reply(@resources_found.first, versioned_resource_class('Immunization'))
      end
      ...
      test :vread_interaction do
        ...
        validate_vread_reply(@resources_found.first, versioned_resource_class('Immunization'))
      end
      ...
      test :history_interaction do
        ...
        validate_history_reply(@resources_found.first, versioned_resource_class('Immunization'))
      end
