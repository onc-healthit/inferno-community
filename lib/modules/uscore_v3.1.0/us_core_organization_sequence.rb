  ...
  module Sequence
    class USCore310OrganizationSequence < SequenceBase
      ...
      test :search_by_name do
        metadata do
          id '02'
          name 'Server returns valid results for Organization search by name.'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          description %(
        ...
        save_delayed_sequence_references(@organization_ary, USCore310OrganizationSequenceDefinitions::DELAYED_REFERENCES)
      ...
      test :search_by_address do
        metadata do
          id '03'
          name 'Server returns valid results for Organization search by address.'
          link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
          description %(
      ...
      test 'Server returns Provenance resources from Organization search by name + _revIncludes: Provenance:target' do
        ...
        save_delayed_sequence_references(provenance_results, USCore310OrganizationSequenceDefinitions::DELAYED_REFERENCES)
