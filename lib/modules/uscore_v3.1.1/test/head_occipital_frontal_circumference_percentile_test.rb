...
describe Inferno::Sequence::USCore311HeadOccipitalFrontalCircumferencePercentileSequence do
  before do
    @sequence_class = Inferno::Sequence::USCore311HeadOccipitalFrontalCircumferencePercentileSequence
  ...
  describe 'Observation search by patient+category+date test' do
    before do
      ...
      @observation = FHIR.from_contents(load_fixture(:head_occipital_frontal_circumference_percentile))
