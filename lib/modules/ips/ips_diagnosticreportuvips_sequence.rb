...
require_relative './profile_definitions/ips_diagnosticreportuvips_sequence_definitions'
  ...
  module Sequence
    class IpsDiagnosticreportuvipsSequence < SequenceBase
      ...
      test :must_support do
        metadata do
          id '03'
          name 'All must support elements are provided in the DiagnosticReport resources returned.'
          link 'http://hl7.org/fhir/uv/ips/StructureDefinition/DiagnosticReport-uv-ips'
          optional
          description %(

            This will look through the DiagnosticReport resource for the following must support elements:
        ...
        skip 'No resource found from Read test' unless @resource_found.present?
        must_supports = IpsDiagnosticreportuvipsSequenceDefinition::MUST_SUPPORTS
