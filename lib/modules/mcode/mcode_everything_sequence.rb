  ...
  module Sequence
    class McodeEverythingSequence < SequenceBase
      ...
      test 'Patient supports $mcode-everything operation' do
        ...
        # everything_response = @client.fetch_patient_record(@instance.mcode_cancer_patient_id)
        everything_response = fetch_patient_mcode_record(@instance.mcode_cancer_patient_id)
